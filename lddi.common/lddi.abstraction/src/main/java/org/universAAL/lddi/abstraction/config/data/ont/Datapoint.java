 ...
 *
 */
public class Datapoint extends ManagedIndividual implements ExternalDatapoint {

	public static final String MY_URI = CGwDataConfigOntology.NAMESPACE + "Datapoint";
	 ...
	 */
	public static final String PROP_DP_ID = CGwDataConfigOntology.NAMESPACE + "datapointID";
	 ...
	 */
	public static final String PROP_VALUE_TYPE = CGwDataConfigOntology.NAMESPACE + "valueType";
	 ...
	 */
	public static final String PROP_BELONGS_TO = CGwDataConfigOntology.NAMESPACE + "belongsTo";
	 ...
	 * the URI of the color property as defined in the used ontology.
	 */
	public static final String PROP_RELATED_ONT_PROPERTY = CGwDataConfigOntology.NAMESPACE + "relatedOntProperty";
	 ...
	 * 
	 */
	public static final String PROP_VALUE_CHANGE_FREQUENCY_PER_SECOND = CGwDataConfigOntology.NAMESPACE + "valueChangeFrequencyPerSecond";
	 ...
	 */
	public static final String PROP_PULL_ADDRESS = CGwDataConfigOntology.NAMESPACE + "pullAddress";
	 ...
	 */
	public static final String PROP_PUSH_ADDRESS = CGwDataConfigOntology.NAMESPACE + "pushAddress";
...
//	public static final String PROP_TRIGGER_ADDRESS = CGwDataConfigOntology.NAMESPACE + "triggerAddress";
	...
	public boolean isReadOnly() {
		return props.get(PROP_PULL_ADDRESS) != null  &&  props.get(PROP_SET_ADDRESS) == null;
	}

	public boolean isWriteOnly() {
		return props.get(PROP_PULL_ADDRESS) == null
				&&  props.get(PROP_PUSH_ADDRESS) == null
				&&  props.get(PROP_SET_ADDRESS) != null;
	}

	public ExternalComponent getComponent() {
		return (ExternalComponent) props.get(PROP_ASSIGNED_COMPONENT);
	}
...
//		return (String) props.get(PROP_TRIGGER_ADDRESS);
//	}
	
	@SuppressWarnings("unchecked")
	public void setComponent(ExternalComponent ec) {
		if (ec != null  &&  props.get(PROP_ASSIGNED_COMPONENT) == null)
			props.put(PROP_ASSIGNED_COMPONENT, ec);			
	}
