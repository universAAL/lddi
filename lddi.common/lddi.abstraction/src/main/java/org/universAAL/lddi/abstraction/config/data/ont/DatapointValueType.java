...
public class DatapointValueType extends ManagedIndividual {
	...
	// class uri
	public static final String MY_URI = CGwDataConfigOntology.NAMESPACE + "DatapointValueType";
	 ...
	 */
	public static final String PROP_VT_ID = CGwDataConfigOntology.NAMESPACE + "valueTypeID";
	 ...
	 */
	public static final String PROP_BASE_TYPE = CGwDataConfigOntology.NAMESPACE + "baseType";
	 ...
	 */
	public static final String PROP_ENUM_VALUES = CGwDataConfigOntology.NAMESPACE + "enumerationOfAllValues";
	 ...
	 */
	public static final String PROP_VALUE_FORMAT = CGwDataConfigOntology.NAMESPACE + "valueFormat";
	 ...
	 */
	public static final String PROP_VALUE_LOWERLIMIT = CGwDataConfigOntology.NAMESPACE + "minValue";
	 ...
	 */
	public static final String PROP_VALUE_STEP = CGwDataConfigOntology.NAMESPACE + "valueStep";
	 ...
	 */
	public static final String PROP_VALUE_UPPERLIMIT = CGwDataConfigOntology.NAMESPACE + "maxValue";
	...
	public List<Object> getEnumValues() {
		return (List<Object>) props.get(PROP_ENUM_VALUES);
	}
