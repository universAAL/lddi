...
public interface Iso11073ContactClosureSensor extends ActivityHubBaseDeviceCategory {
	...
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_CONTACTCLOSURE.toString();

	// // from OSGi DAS Spec
	// public static int MATCH_SERIAL = 10; // an exact match including the
	// serial number
	// public static int MATCH_VERSION = 8; // matches the right class, make
	// model and version
	// public static int MATCH_MODEL = 6; // matches the right class and make
	// model
