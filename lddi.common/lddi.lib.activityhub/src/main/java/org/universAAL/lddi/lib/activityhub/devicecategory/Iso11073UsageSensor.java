...
/**
 * OSGi DeviceCategory for Activityhub Usage sensor
 *
 ...
 */
public interface Iso11073UsageSensor extends ActivityHubBaseDeviceCategory {

	// used in driver match method
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_USAGE.toString();
