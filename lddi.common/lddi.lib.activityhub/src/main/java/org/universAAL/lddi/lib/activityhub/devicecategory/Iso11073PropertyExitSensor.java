...
/**
 * OSGi DeviceCategory for Activityhub PropertyExit sensor
 * 
 ...
 */
public interface Iso11073PropertyExitSensor extends ActivityHubBaseDeviceCategory {

	// used in driver match method
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_PROPEXIT.toString();
