...
/**
 * OSGi DeviceCategory for Activityhub Fall sensor
 * 
 ...
 */
public interface Iso11073FallSensor extends ActivityHubBaseDeviceCategory {

	// used in driver match method
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_FALL.toString();
