...
/**
 * OSGi DeviceCategory for Activityhub Pers sensor
 *
 ...
 */
public interface Iso11073PersSensor extends ActivityHubBaseDeviceCategory {

	// used in driver match method
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_PERS.toString();
