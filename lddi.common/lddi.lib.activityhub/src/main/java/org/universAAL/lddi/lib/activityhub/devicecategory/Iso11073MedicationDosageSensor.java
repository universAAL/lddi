...
/**
 * OSGi DeviceCategory for Activityhub MedicationDosage sensor
 *
 ...
 */
public interface Iso11073MedicationDosageSensor extends ActivityHubBaseDeviceCategory {

	// used in driver match method
	public static String MY_DEVICE_CATEGORY = ActivityHubDeviceCategory.MDC_AI_TYPE_SENSOR_DOSAGE.toString();
