...
public class PowerStatus implements IASN1PreparedElement {
	...
	@ASN1Element(name = "PowerStatus", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public PowerStatus(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(PowerStatus.class);
