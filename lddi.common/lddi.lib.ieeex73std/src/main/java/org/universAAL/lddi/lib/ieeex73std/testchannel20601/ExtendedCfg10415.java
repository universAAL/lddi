...
public class ExtendedCfg10415 {
	...
	public ExtendedCfg10415() {
		...
		apdu = new byte[] { (byte) 0xE7, (byte) 0x00, // APDU CHOICE Type
				...
				(byte) 0x12, (byte) 0x35, // invoke-id = 0x1235 (start of
											// DataApdu. MDER encoded.)
				...
				(byte) 0x00, (byte) 0x90, // event-info.length = 144 (start of
											// ConfigReport)
				(byte) 0x40, (byte) 0x00, // config-report-id
				(byte) 0x00, (byte) 0x03, // config-obj-list.count = 3
											// Measurement objects will be
											// announced
				(byte) 0x00, (byte) 0x8A, // config-obj-list.length = 138
				(byte) 0x00, (byte) 0x06, // obj-class = MDC_MOC_VMO_METRIC_NU

				(byte) 0x00, (byte) 0x01, // obj-handle = 1 (1st Measurement is
											// body weight)
				...
				(byte) 0x00, (byte) 0x02, (byte) 0xE1, (byte) 0x40, // MDC_PART_SCADA
																	// |
				...
				(byte) 0xF0, (byte) 0x40, // intermittent, stored data, upd &
											// msmt aperiodic, agent init,
											// measured
				...
				(byte) 0x0A, (byte) 0x56, (byte) 0x00, (byte) 0x04, // MDC_ATTR_NU_VAL_OBS_SIMP
																	// | value
																	// length =
																	// 4
				(byte) 0x09, (byte) 0x90, (byte) 0x00, (byte) 0x08, // MDC_ATTR_TIME_STAMP_ABS
																	// | value
																	// length =
																	// 8
				(byte) 0x00, (byte) 0x06, // obj-class = MDC_MOC_VMO_METRIC_NU

				(byte) 0x00, (byte) 0x02, // obj-handle = 2 (2nd Measurement is
											// body height)
				(byte) 0x00, (byte) 0x04, // attributes.count = 4
				(byte) 0x00, (byte) 0x24, // attributes.length = 36
				(byte) 0x09, (byte) 0x2F, // attribute-id = MDC_ATTR_ID_TYPE
				(byte) 0x00, (byte) 0x04, // attribute-value.length = 4
				(byte) 0x00, (byte) 0x02, (byte) 0xE1, (byte) 0x44, // MDC_PART_SCADA
																	// |
																	// MDC_LEN_BODY_ACTUAL
				(byte) 0x0A, (byte) 0x46, // attribute-id =
											// MDC_ATTR_METRIC_SPEC_SMALL
				...
				(byte) 0xF0, (byte) 0x48, // intermittent, stored data, upd &
											// msmt aperiodic, agent init,
											// manual
				(byte) 0x09, (byte) 0x96, // attribute-id = MDC_ATTR_UNIT_CODE
				(byte) 0x00, (byte) 0x02, // attribute-value.length = 2
				...
				(byte) 0x00, (byte) 0x03, // obj-handle = 3 3rd Measurement is
											// body mass index)
				(byte) 0x00, (byte) 0x05, // attributes.count = 5
				(byte) 0x00, (byte) 0x2A, // attributes.length = 42
				(byte) 0x09, (byte) 0x2F, // attribute-id = MDC_ATTR_ID_TYPE
				(byte) 0x00, (byte) 0x04, // attribute-value.length = 4
				(byte) 0x00, (byte) 0x02, (byte) 0xE1, (byte) 0x50, // MDC_PART_SCADA
																	// |
																	// MDC_RATIO_MASS_BODY_LEN_SQ
				(byte) 0x0A, (byte) 0x46, // attribute-id =
											// MDC_ATTR_METRIC_SPEC_SMALL
				(byte) 0x00, (byte) 0x02, // attribute-value.length = 2
				(byte) 0xF0, (byte) 0x42, // intermittent, stored data, upd &
											// msmt aperiodic, agent init,
											// calculated
				(byte) 0x09, (byte) 0x96, // attribute-id = MDC_ATTR_UNIT_CODE
				(byte) 0x00, (byte) 0x02, // attribute-value.length = 2
				(byte) 0x07, (byte) 0xA0, // MDC_DIM_KG_PER_M_SQ
				(byte) 0x0A, (byte) 0x47, // attribute-id =
