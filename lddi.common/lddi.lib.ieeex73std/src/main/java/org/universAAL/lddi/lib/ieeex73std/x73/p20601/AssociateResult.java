...
public class AssociateResult implements IASN1PreparedElement {
	...
	@ASN1Element(name = "AssociateResult", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public AssociateResult(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(AssociateResult.class);
