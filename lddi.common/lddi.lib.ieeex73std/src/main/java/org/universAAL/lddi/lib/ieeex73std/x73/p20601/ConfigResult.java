...
public class ConfigResult implements IASN1PreparedElement {
	...
	@ASN1Element(name = "ConfigResult", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public ConfigResult(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(ConfigResult.class);
