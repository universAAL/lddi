...
public class DataReqModeFlags implements IASN1PreparedElement {
	...
	@ASN1Element(name = "DataReqModeFlags", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public DataReqModeFlags(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(DataReqModeFlags.class);
