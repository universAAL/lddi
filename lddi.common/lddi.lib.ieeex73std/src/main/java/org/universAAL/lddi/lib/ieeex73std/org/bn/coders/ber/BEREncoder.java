...
import org.universAAL.lddi.lib.ieeex73std.org.bn.coders.ElementType;
...
import org.universAAL.lddi.lib.ieeex73std.org.bn.types.ObjectIdentifier;
...
public class BEREncoder<T> extends Encoder<T> {
	...
	public int encodeSequence(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		if (!CoderUtils.isSequenceSet(elementInfo))
			resultSize += encodeHeader(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
					ElementType.Constructed, UniversalTag.Sequence), resultSize, stream);
		else
			resultSize += encodeHeader(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
	...
	public int encodeChoice(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		if ((elementInfo.hasPreparedInfo() && elementInfo.hasPreparedASN1ElementInfo()
			...
			resultSize += encodeHeader(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.ContextSpecific,
					ElementType.Constructed, UniversalTag.LastUniversal), sizeOfChoiceField, stream);
		}
	...
	public int encodeEnumItem(Object enumConstant, Class enumClass, OutputStream stream, ElementInfo elementInfo)
		...
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Enumerated), stream);
		return resultSize;
	}
	...
	public int encodeBoolean(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Boolean), stream);
		return resultSize;
	}
	...
	public int encodeInteger(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeLength(szOfInt, stream);
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Integer), stream);
		return resultSize;
	}
	...
	public int encodeReal(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeLength(szOfInt, stream);
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Real), stream);
		return resultSize;
	}
	...
	public int encodeOctetString(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.OctetString), stream);
		return resultSize;
	}
	...
	public int encodeBitString(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeLength(sizeOfString, stream);
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Bitstring), stream);
		return resultSize;
	}
	...
	public int encodeString(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeLength(sizeOfString, stream);
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, CoderUtils.getStringTagForElement(elementInfo)), stream);
		return resultSize;
	}
	...
	public int encodeSequenceOf(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		if (!CoderUtils.isSequenceSetOf(elementInfo)) {
			resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
					ElementType.Constructed, UniversalTag.Sequence), stream);
		} else {
			resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
					ElementType.Constructed, UniversalTag.Set), stream);
		}
		return resultSize;
	}
	...
	public int encodeNull(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		int resultSize = 1;
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.Null), stream);
		return resultSize;
	}
	...
	public int encodeObjectIdentifier(Object object, OutputStream stream, ElementInfo elementInfo) throws Exception {
		...
		resultSize += encodeTag(BERCoderUtils.getTagValueForElement(elementInfo, TagClass.Universal,
				ElementType.Primitive, UniversalTag.ObjectIdentifier), stream);
		return resultSize;
	}
}
