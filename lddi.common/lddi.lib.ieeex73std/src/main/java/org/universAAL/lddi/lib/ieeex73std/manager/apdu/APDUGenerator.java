...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.AareApdu;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.Abort_reason;
...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.AssociateResult;
...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.DataReqModeFlags;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.EncodingRules;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.ErrorResult;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.EventReportResultSimple;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.FunctionalUnits;
...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.InvokeIDType;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.NomenclatureVersion;
...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.ProtocolVersion;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.PrstApdu;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.RejectResult;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.RelativeTime;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.ReleaseRequestReason;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.ReleaseResponseReason;
...
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.RoerErrorValue;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.RorjProblem;
import org.universAAL.lddi.lib.ieeex73std.x73.p20601.SystemType;
...
public class APDUGenerator<T> {
	...
	// Association request. Not implemented because Managers don't send this
	// kind of APDU.
	...
	public ApduType AareApduGenerator(int reason) {
		...
		if (reason == StatusCodes.ACCEPTED || reason == StatusCodes.ACCEPTED_UNKNOWN_CONFIG) {
			...
			// Generate the Phd Association Information to inform the Agent what
			// parameters are going to be used in this connection
			...
			// NomenclatureVersion
			NomenclatureVersion nomen_version = new NomenclatureVersion(
					new BITS_32(new BitString(Manager.nomenclature_version)));
	 ...
	 * release request
	 */
	// The manager will only send the reason StatusCodes.REL_REQ_RE_NORMAL.
	// No-more-configurations and configuration-changed reasons come from Agent.
	 ...
	 * @param typeofreport
	 *            integer with the code of the report received.
	 * @return
	 */
	public ApduType MeasureACKGenerator(DataApdu datareceived, int typeofreport) {
		...
		// The type of report will be the same of the Apdu received from the
		// Agent.
	...
	public ApduType RoerGenerator(InvokeIDType invokeid, int err_code) {
		...
		roer.setParameter(new byte[] {}); // no additional information will be
											// sent
		mct.selectRoer(roer);
		data.setMessage(mct);
		byte[] data_encoded = null;
