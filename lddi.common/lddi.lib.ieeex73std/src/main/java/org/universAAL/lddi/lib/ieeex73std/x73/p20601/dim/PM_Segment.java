...
/**
 * An instance of the PM-segment class represents a persistently stored episode
 * of measurement data. A PMsegment object is not part of the static agent
 * configuration because the number of instantiated PM-segment instances may
 * dynamically change. The manager accesses PM-segment objects indirectly by
 * methods and events of the PM-store object.
 *
 */
