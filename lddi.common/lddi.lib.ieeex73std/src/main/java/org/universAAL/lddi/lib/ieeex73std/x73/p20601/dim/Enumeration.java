 ...
 * annotation information. The values of the enumeration object are coded in the
 * form of normative codes (as defined in ISO/IEEE 11073- 10101 [B12]) or in the
 * form of free text. The values of the enumeration object are sent from the
 * agent to the manager using the EVENT REPORT service (see 7.3). This class is
 * derived from the metric base class.
 *
 */
