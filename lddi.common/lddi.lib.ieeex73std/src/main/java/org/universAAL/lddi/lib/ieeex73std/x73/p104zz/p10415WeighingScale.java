...
public class p10415WeighingScale extends DeviceSpecialization {
	...
	public p10415WeighingScale(IDecoder decoder) throws Exception {
		...
		generateBodyWeight();
		// generateBodyHeight(); not implemented because is part of extended
		// configurations of Weighing scale.
		// generateBodyMassIndex(); not implemented because is part of extended
		// configurations of Weighing scale.
