...
public class SegmStatType implements IASN1PreparedElement {
	...
	@ASN1Element(name = "SegmStatType", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public SegmStatType(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(SegmStatType.class);
