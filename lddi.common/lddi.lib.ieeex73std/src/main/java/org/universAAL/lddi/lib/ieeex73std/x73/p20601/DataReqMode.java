...
public class DataReqMode implements IASN1PreparedElement {
	...
	@ASN1Element(name = "DataReqMode", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public DataReqMode(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(DataReqMode.class);
