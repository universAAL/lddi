...
public class DataApdu implements IASN1PreparedElement {
	...
	public static class MessageChoiceType implements IASN1PreparedElement {
		...
		private static IASN1PreparedElementData preparedData_MessageChoiceType = CoderFactory.getInstance()
				.newPreparedElementData(MessageChoiceType.class);
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(DataApdu.class);
