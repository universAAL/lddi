...
public class SFloatType {
	...
	public SFloatType(short num) throws Exception {
		short aux_exponent = (short) (num >> 12); // will be like this: short (2
													// bytes) 00000000
													// 0000exponent(4bits)
		short aux_mantissa = (short) (num & 0x0FFF); // AND operation for
														// extract the mantissa,
														// it will be like this:
														// 0000 MANTISSA(4 bits)
														// MANTISSA2

		// negative?
		if ((aux_mantissa & 0x0800) != 0) { // if it has the MSb of the mantissa
											// to one (last 12 bits of the
											// SFloat)
