...
public class ReleaseRequestReason implements IASN1PreparedElement {
	...
	@ASN1Element(name = "ReleaseRequestReason", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public ReleaseRequestReason(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(ReleaseRequestReason.class);
