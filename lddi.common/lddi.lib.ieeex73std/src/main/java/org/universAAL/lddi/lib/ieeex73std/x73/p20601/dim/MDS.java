 ...
 * shown in Figure 4. The toplevel object of each agent is instantiated from the
 * MDS class. Each agent has one MDS object. The MDS represents the
 * identification and status of the agent through its attributes.
 *
 */
public abstract class MDS extends DIM implements MDS_Events, GET_Service {
	...
	/*
	 * //TODO MDS-Data-Request: This method allows the manager system to enable
	 * or disable measurement data transmission from the agent (see 8.9.3.3.3
	 * for a description).
	 */
	public abstract void MDS_Data_Request();

	/*
	 * // TODO Set-Time: This method allows the manager system to set a
