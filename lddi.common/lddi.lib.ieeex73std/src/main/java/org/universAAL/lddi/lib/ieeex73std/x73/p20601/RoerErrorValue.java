...
public class RoerErrorValue implements IASN1PreparedElement {
	...
	@ASN1Element(name = "RoerErrorValue", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public RoerErrorValue(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(RoerErrorValue.class);
