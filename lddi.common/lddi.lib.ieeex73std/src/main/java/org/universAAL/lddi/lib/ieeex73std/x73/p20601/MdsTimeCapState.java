...
public class MdsTimeCapState implements IASN1PreparedElement {
	...
	@ASN1Element(name = "MdsTimeCapState", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public MdsTimeCapState(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(MdsTimeCapState.class);
