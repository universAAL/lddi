...
public class MetricSpecSmall implements IASN1PreparedElement {
	...
	@ASN1Element(name = "MetricSpecSmall", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public MetricSpecSmall(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(MetricSpecSmall.class);
