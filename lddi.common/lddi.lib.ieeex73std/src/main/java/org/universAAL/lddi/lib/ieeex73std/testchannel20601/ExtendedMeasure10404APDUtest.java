...
public class ExtendedMeasure10404APDUtest {
	...
	public ExtendedMeasure10404APDUtest() {
		...
		apdu = new byte[] { (byte) 0xE7, (byte) 0x00, // APDU CHOICE Type
				...
				(byte) 0x88, (byte) 0x88, // invoke-id = 0x1236 (sequence
											// number)
				...
				(byte) 0x00, (byte) 0x02, // ScanReportInfoFixed.obs-scan-fixed.count
											// = 2
				(byte) 0x00, (byte) 0x1C, // ScanReportInfoFixed.obs-scan-fixed.length
											// = 28
				...
				(byte) 0x00, (byte) 0x0A, // ScanReportInfoFixed.obs-scan-fixed.value[0].obj-handle
											// = 10
				(byte) 0x00, (byte) 0x0A, // ScanReportInfoFixed.obs-scan-fixed.value[0].
											// obs-val-data.length = 10
