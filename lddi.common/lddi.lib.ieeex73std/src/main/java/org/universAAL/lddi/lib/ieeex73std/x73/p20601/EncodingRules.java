...
public class EncodingRules implements IASN1PreparedElement {
	...
	@ASN1Element(name = "EncodingRules", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public EncodingRules(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(EncodingRules.class);
