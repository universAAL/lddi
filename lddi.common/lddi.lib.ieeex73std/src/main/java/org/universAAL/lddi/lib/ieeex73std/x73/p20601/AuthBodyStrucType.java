...
public class AuthBodyStrucType implements IASN1PreparedElement {
	...
	@ASN1Element(name = "AuthBodyStrucType", isOptional = false, hasTag = false, hasDefaultValue = false)

	private INT_U8 value;

	public AuthBodyStrucType() {
	}

	public AuthBodyStrucType(INT_U8 value) {
		this.value = value;
	}

	public void setValue(INT_U8 value) {
		this.value = value;
	}

	public INT_U8 getValue() {
		return this.value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(AuthBodyStrucType.class);
