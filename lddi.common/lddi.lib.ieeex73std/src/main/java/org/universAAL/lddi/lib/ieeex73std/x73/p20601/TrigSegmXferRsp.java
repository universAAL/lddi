...
public class TrigSegmXferRsp implements IASN1PreparedElement {
	...
	@ASN1Element(name = "TrigSegmXferRsp", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public TrigSegmXferRsp(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(TrigSegmXferRsp.class);
