...
public class RorjProblem implements IASN1PreparedElement {
	...
	@ASN1Element(name = "RorjProblem", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public RorjProblem(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(RorjProblem.class);
