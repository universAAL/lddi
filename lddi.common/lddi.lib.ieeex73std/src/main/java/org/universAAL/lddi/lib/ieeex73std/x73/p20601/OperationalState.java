...
public class OperationalState implements IASN1PreparedElement {
	...
	@ASN1Element(name = "OperationalState", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public OperationalState(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(OperationalState.class);
