...
public class ExtendedCfg10404 {
	...
	public ExtendedCfg10404() {
		...
		apdu = new byte[] { (byte) 0xE7, (byte) 0x00, // APDU CHOICE Type
				...
				(byte) 0x99, (byte) 0x99, // invoke-id = 0x1235 (start of
				...
				(byte) 0x00, (byte) 0x96, // event-info.length = 150 (start of
											// ConfigReport)
				...
				(byte) 0x0A, (byte) 0x4C, (byte) 0x00, (byte) 0x02, // MDC_ATTR_NU_VAL_OBS_BASIC
																	// | value
																	// length =
																	// 2
				...
				// 8
				(byte) 0x00, (byte) 0x06, // obj-class = MDC_MOC_VMO_METRIC_NU
				(byte) 0x00, (byte) 0x0A, // obj-handle = 10 (2nd Measurement is
											// pulse rate)
				(byte) 0x00, (byte) 0x04, // attributes.count = 4
				(byte) 0x00, (byte) 0x24, // attributes.length = 36
				...
				(byte) 0x09, (byte) 0x2F, // attribute-id = MDC_ATTR_ID_TYPE
				(byte) 0x00, (byte) 0x04, // attribute-value.length = 4
				(byte) 0x00, (byte) 0x02, (byte) 0x48, (byte) 0x1A, // MDC_PART_SCADA
																	// |
				...
				// 12
				(byte) 0x0A, (byte) 0x61, // attribute-id =
				...
				(byte) 0x00, (byte) 0x02, (byte) 0x4C, (byte) 0x34, // MDC_PART_SCADA
																	// |
																	// MDC_MODALITY_FAST
