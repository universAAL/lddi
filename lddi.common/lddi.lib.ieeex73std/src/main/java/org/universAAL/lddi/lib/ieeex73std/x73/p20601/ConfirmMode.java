...
public class ConfirmMode implements IASN1PreparedElement {
	...
	@ASN1Element(name = "ConfirmMode", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public ConfirmMode(INT_U16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(ConfirmMode.class);
