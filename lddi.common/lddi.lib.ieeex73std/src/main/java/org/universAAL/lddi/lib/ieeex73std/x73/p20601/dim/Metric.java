 ...
 * status, and context data. The metric class is not instantiated; therefore, it
 * is never part of the agent configuration. As a base class, it defines all
 * attributes, methods, events, and services that are common for all objects
