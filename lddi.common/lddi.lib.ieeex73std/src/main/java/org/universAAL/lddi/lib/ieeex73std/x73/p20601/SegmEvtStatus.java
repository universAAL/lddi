...
public class SegmEvtStatus implements IASN1PreparedElement {
	...
	@ASN1Element(name = "SegmEvtStatus", isOptional = false, hasTag = false, hasDefaultValue = false)
	...
	public SegmEvtStatus(BITS_16 value) {
		this.value = value;
	}
	...
	private static IASN1PreparedElementData preparedData = CoderFactory.getInstance()
			.newPreparedElementData(SegmEvtStatus.class);
