...
public class Aarq10415APDUtest {
	...
	public Aarq10415APDUtest() {
		...
		apdu = new byte[] { (byte) 0xE2, (byte) 0x00, // choice APDU
				...
				(byte) 0x01, (byte) 0x00, // data-req-agent-count |
											// data-req-manager-count
				(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, // option
																	// list.count
																	// | option
																	// list
																	// length
	...
	/*
	 * =========================================================================
	 * =================== Data received from agent: 0xE2 0x00 0x00 0x32 0x80
	 * 0x00 0x00 0x00 0x00 0x01 0x00 0x2A 0x50 0x79 0x00 0x26 0x80 0x00 0x00
	 * 0x00 0x80 0x00 0x80 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x80 0x00
	 * 0x00 0x00 0x08 0x00 0x09 0x1F 0xFF 0xFE 0x80 0x0A 0xE0 0x05 0xDC 0x00
	 * 0x81 0x01 0x00 0x00 0x00 0x00 0x00
	 * =========================================================================
	 * ===================
	 * 
	 */
