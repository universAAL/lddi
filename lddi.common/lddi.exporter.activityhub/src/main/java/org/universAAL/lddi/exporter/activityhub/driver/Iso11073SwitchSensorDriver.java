...
public class Iso11073SwitchSensorDriver implements Driver {
	 ...
	 * @param logTracker
	 */
	public Iso11073SwitchSensorDriver(ActivityHubDriverClient client, BundleContext context) {
		this.client = client;
	...
	public int match(ServiceReference reference) throws Exception {
		...
		try {
			...
			this.logger.log(LogService.LOG_DEBUG,
					"Could not cast DEVICE_CATEGORY of requesting" + " device to String. No match!");
			return matchValue;
		}
	...
	public String attach(ServiceReference reference) throws Exception {
		...
		Iso11073SwitchSensorInstance instance = new Iso11073SwitchSensorInstance(this.context, client, this.logger);
