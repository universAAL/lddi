 ...
 *
 */
public class Iso11073MotionSensorDriver implements Driver {
	...
	private static final String MY_DRIVER_ID = "org.universAAL.iso11073.motionsensor.0.0.1";

	private ServiceRegistration regDriver;

	// Set of driver instances
	private Set<Iso11073MotionSensorInstance> connectedDriver;

	/**
	 * @param context
	 * @param logTracker
	 */
	public Iso11073MotionSensorDriver(ActivityHubDriverClient client, BundleContext context) {
		this.client = client;
		this.context = context;
		this.logger = client.getLogger();

		this.connectedDriver = new HashSet<Iso11073MotionSensorInstance>();
	 ...
	 */
	public Set<Iso11073MotionSensorInstance> getConnectedDriver() {
