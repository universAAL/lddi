...
public class Iso11073UsageSensorDriver implements Driver {
	 ...
	 * @param logTracker
	 */
	public Iso11073UsageSensorDriver(ActivityHubDriverClient client, BundleContext context) {
		this.client = client;
	...
	public String attach(ServiceReference reference) throws Exception {
		...
		Iso11073UsageSensorInstance instance = new Iso11073UsageSensorInstance(this.context, client, this.logger);
