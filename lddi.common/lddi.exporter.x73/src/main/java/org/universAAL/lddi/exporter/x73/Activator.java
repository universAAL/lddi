...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		// if(1==1)
		// throw new RuntimeException("Test in Activator: " +
	...
	class MyThread implements Runnable {
		...
		public void run() {
			// serviceProvider = new ActivityHubServiceProvider(moduleContext,
			// busServer);
	...
	// }catch(Exception ex) {
	// System.out.println("Unable to load native library. Please, check your
	// path and OSGi manifest settings...");
	// }
	// }
}
