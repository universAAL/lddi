...
public class ISO11073ContextProvider {
	...
	public ISO11073ContextProvider(ModuleContext mc, ISO11073DBusServer x73Server) {

		this.theServer = x73Server;
		this.logger = x73Server.getLogger();

		// prepare for context publishing
		ContextProvider info = new ContextProvider(X73Ontology.NAMESPACE + "x73ContextProvider");
		...
		// info.setProvidedEvents(new ContextEventPattern[] { new
		// ContextEventPattern() });
	...
	public void publishDevData(String deviceId, String manufacturer, String modelNumber, int century, int year,
			int month, int day, int hour, int minute, int second, int sec_fractions, SystemModel sm,
	...
	// This method is called by MyAgent.Disassociated and publishes the
	// measurements of the bathing scale
	// to the context bus. Such a method has to be implemented for every device
	// model.
	public void publishWeight(String deviceId, String weight, String unitCode, int century, int year, int month,
			int day, int hour, int minute, int second, int sec_fractions, String manufacturer, String modelNumber,
			String systemId, String typeSpecList) {
		...
		publishDevData(deviceId, manufacturer, modelNumber, century, year, month, day, hour, minute, second,
				sec_fractions, sm, as);
	...
	// This method is called by MyAgent.Disassociated and publishes the pulse
	// measurements
	// to the context bus. Such a method has to be implemented for every device
	// model.
	public void publishPulse(String deviceId, String pulse, String unitCode, int century, int year, int month, int day,
			int hour, int minute, int second, int sec_fractions, String manufacturer, String modelNumber,
			String systemId, String typeSpecList) {
