...
public class ProvidedContinuaHdpManagerService extends ContinuaHealthManager {
	...
	static {
		...
		switchOn.myProfile.addAddEffect(new String[] { ContinuaHealthManager.PROP_HAS_CONTINUA_DEVICE }, input1);
		...
		switchOff.myProfile.addChangeEffect(new String[] { ContinuaHealthManager.PROP_HAS_NOT_CONTINUA_DEVICE },
				input2);
