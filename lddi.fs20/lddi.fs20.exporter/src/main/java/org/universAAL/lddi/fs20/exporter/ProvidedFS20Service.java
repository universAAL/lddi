...
public class ProvidedFS20Service extends DeviceService {
	...
	// FS20CONTROLLER_NAMESPACE="http://ontology.persona.ima.igd.fhg.de/FS20Controlled.owl#";

	public static final String FS20_SERVER_NAMESPACE = System.getProperty(
	...
	static {
		...
		// String[] ppAbsLocation = new String[]
		// {ProvidedFS20Service.PROP_CONTROLS_DISPLAYS,
		// FS20Device.PROP_PHYSICAL_LOCATION };
		...
		// turn the diplay on, in this case there are twelve animations are
		// defined in the @FS20Gong

		// animation 1
		ProvidedFS20Service startAnimation1Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_1);
		startAnimation1Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation1Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(1));
		profiles[3] = startAnimation1Service.myProfile;

		// animation 2
		ProvidedFS20Service startAnimation2Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_2);
		startAnimation2Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation2Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(2));
		profiles[4] = startAnimation2Service.myProfile;

		// animation 3
		ProvidedFS20Service startAnimation3Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_3);
		startAnimation3Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation3Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(3));
		profiles[5] = startAnimation3Service.myProfile;

		// animation 4
		ProvidedFS20Service startAnimation4Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_4);
		startAnimation4Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation4Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(4));
		profiles[6] = startAnimation4Service.myProfile;

		// animation 5
		ProvidedFS20Service startAnimation5Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_5);
		startAnimation5Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation5Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(5));
		profiles[7] = startAnimation5Service.myProfile;

		// animation 6
		ProvidedFS20Service startAnimation6Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_6);
		startAnimation6Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation6Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(6));
		profiles[8] = startAnimation6Service.myProfile;

		// animation 7
		ProvidedFS20Service startAnimation7Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_7);
		startAnimation7Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation7Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(7));
		profiles[9] = startAnimation7Service.myProfile;

		// animation 8
		ProvidedFS20Service startAnimation8Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_8);
		startAnimation8Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation8Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(8));
		profiles[10] = startAnimation8Service.myProfile;

		// animation 9
		ProvidedFS20Service startAnimation9Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_9);
		startAnimation9Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation9Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(9));
		profiles[11] = startAnimation9Service.myProfile;

		// animation 10
		ProvidedFS20Service startAnimation10Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_10);
		startAnimation10Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation10Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(10));
		profiles[12] = startAnimation10Service.myProfile;

		// animation 11
		ProvidedFS20Service startAnimation11Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_11);
		startAnimation11Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation11Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(11));
		profiles[13] = startAnimation11Service.myProfile;

		// animation 12
		ProvidedFS20Service startAnimation12Service = new ProvidedFS20Service(SERVICE_DISPLAY_ANIMATION_12);
		startAnimation12Service.addFilteringInput(INPUT_URI_DISPLAY, LightActuator.MY_URI, 1, 1, ppControls_DISPLAYS);
		startAnimation12Service.myProfile.addChangeEffect(ValuePath.getThePath(), new Integer(12));
