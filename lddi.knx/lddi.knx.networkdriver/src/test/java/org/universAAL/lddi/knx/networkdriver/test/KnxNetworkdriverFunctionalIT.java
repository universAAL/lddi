...
// * To enable them an argument "-DskipTests=false" has to be added to the "mvn"
// invocation in the command line.
// *
...
//// KnxNetworkDriverImp netDrv = new KnxNetworkDriverImp(Activator.context,
// null);
//
...
//// junitBundles()); // provisions JUnit and its dependencies as OSGi bundles
