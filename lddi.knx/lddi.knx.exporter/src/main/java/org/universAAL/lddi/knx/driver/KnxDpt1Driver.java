 ...
 * on new device references coming from OSGi DeviceManager; matching on
...
public class KnxDpt1Driver implements Driver {
	 ...
	 */
	public final Map<String, KnxDpt1Instance> connectedDriverInstanceMap = new ConcurrentHashMap<String, KnxDpt1Instance>();

	/**
	 * @param knxManager
	 * @param context
	 */
	public KnxDpt1Driver(IKnxDriverClient client, BundleContext context) {
		this.client = client;
	...
	public String attach(ServiceReference reference) throws Exception {
		...
		KnxDpt1Instance instance = new KnxDpt1Instance(this);
