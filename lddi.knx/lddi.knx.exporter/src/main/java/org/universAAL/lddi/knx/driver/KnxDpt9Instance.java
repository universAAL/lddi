...
public class KnxDpt9Instance extends KnxDriver
		implements IKnxDpt9, IKnxReceiveMessage, ServiceTrackerCustomizer, Constants {
	...
	public void modifiedService(ServiceReference reference, Object service) {
		this.logger.log(LogService.LOG_INFO,
				"Tracked knx groupDevice service was modified. " + "Going to update the KnxDpt9Instance");
	...
	public void removedService(ServiceReference reference, Object service) {
		...
		// KnxDpt9GroupDevice knxDev = (KnxDpt9GroupDevice)
	...
	public void newMessageFromKnxBus(byte[] event) {
		...
		this.logger.log(LogService.LOG_INFO,
				"Driver " + IKnxDpt9.MY_DEVICE_CATEGORY + " for groupDevice " + this.groupDevice.getGroupAddress()
		...
		this.client.incomingSensorEvent(this.groupDevice.getGroupAddress(),
				this.groupDevice.getDatapointTypeMainNumber(), this.groupDevice.getDatapointTypeSubNumber(), value);
	}
