...
public abstract class KnxGroupDeviceFactory {
	 ...
	 * @param dptMainNumber
	 *            e.g.: 1
	 * @return KnxGroupDevice object or null if no implementation for the given
	 *         datapoint number exists
	 */
	public static KnxGroupDevice getKnxGroupDevice(int dptMainNumber) {

		switch (dptMainNumber) {
		case 1:
			return new KnxDpt1GroupDevice();
		case 2:
			return new KnxDpt2GroupDevice();
		case 3:
			return new KnxDpt3GroupDevice();
		case 4:
			return new KnxDpt4GroupDevice();
		case 5:
			return new KnxDpt5GroupDevice();
		// case 6: return new KnxDpt6Device();
		// case 7: return new KnxDpt7Device();
		// case 8: return new KnxDpt8Device();
		case 9:
			return new KnxDpt9GroupDevice();
