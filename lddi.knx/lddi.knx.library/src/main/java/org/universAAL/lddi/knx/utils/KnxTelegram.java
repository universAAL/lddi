...
public class KnxTelegram {
	...
	private byte ipFillByte = (byte) 0xd0; // only in knx packets over IP! d0 in Weinzierl docu; e0 in ETS sent telegrams
	...
	private byte apciDataByte; // is overlapping with the data byte (e.g. for 1-bit datatypes -> 80, 81)
...
//		builder.append('#');
	 ...
	 * last 5 bits of the apci/data byte are reserved for data!
	 * other data bytes go to extraDataByte[]
	 */
...
////		System.arraycopy(extraDataByte, 0, this.dataByte, 0, extraDataByte.length);
