...
public class KnxDeviceConfig {
	 ...
	 */
	public KnxDeviceConfig(String knxGroupAddress, Dictionary configurationProperties, String configurationPid) {
