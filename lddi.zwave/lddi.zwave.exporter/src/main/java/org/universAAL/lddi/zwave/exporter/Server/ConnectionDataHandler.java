...
public class ConnectionDataHandler
		implements IWriteCompletionHandler, ISocketServerConnection, ISocketServerProtocolDecoderListener {
	 ...
	 * @throws IOException
	 *             error handling onWritten event
	 */
